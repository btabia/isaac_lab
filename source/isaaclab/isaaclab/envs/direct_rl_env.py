...
class DirectRLEnv(gym.Env):
    ...
    def step(self, action: torch.Tensor) -> VecEnvStepReturn:
        ...
        """
        action = action.to(self.device) # modified for sb3
        ...
        for __ in range(self.cfg.decimation_cmd):
            self._update_obj_pos()
        # perform physics stepping
            for _ in range(self.cfg.decimation_ctrl):
        ...
        # update observations - modified to suit our needs as observations need to be before the rewards
    ...
    @abstractmethod # specialy for malleabot
